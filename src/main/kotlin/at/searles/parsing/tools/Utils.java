package at.searles.parsing.tools;

import at.searles.parsing.*;
import at.searles.parsing.tools.properties.*;
import at.searles.parsing.tools.common.SwapPairFold;
import at.searles.parsing.tools.list.*;
import at.searles.parsing.tools.common.PairFold;
import at.searles.parsing.tools.common.ValueInitializer;
import at.searles.parsing.tools.map.EmptyMap;
import at.searles.parsing.tools.map.PutFold;
import at.searles.parsing.tools.map.SingleMap;
import at.searles.parsing.tools.opt.NoneInitializer;
import at.searles.parsing.tools.opt.SomeMapping;
...
public class Utils {
    ...
    public static <T> Mapping<Properties, T> create(Class<? extends T> clazz, boolean withInfo, String...properties) {
        return new Creator<>(clazz, withInfo, properties);
    }
