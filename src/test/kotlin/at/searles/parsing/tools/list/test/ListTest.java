package at.searles.parsing.tools.list.test;

import at.searles.lexer.Lexer;
import at.searles.parsing.*;
import at.searles.parsing.printing.ConcreteSyntaxTree;
import at.searles.parsing.tools.list.ImmutableList;
...
public class ListTest {
    ...
    private final Parser<Object> id = Parser.fromRegex(StringToRegex.parse("[a-z]+"), tokenizer, false, new Mapping<CharSequence, Object>() {
        @Override
    ...
    private final Parser<Object> num = Parser.fromRegex(StringToRegex.parse("[0-9]+"), tokenizer, false, new Mapping<CharSequence, Object>() {
        @Override
        public Object parse(ParserStream stream, @NotNull CharSequence left) {
